...
if (
    ...
    if (Session::getCurrentInterface() == "central") {
        Html::header(ReportDashboard::getTypeName(1), $_SERVER['PHP_SELF'], 'report');
    } else {
        Html::helpHeader(ReportDashboard::getTypeName(1));
    }

    // $pref = new Preference();
    // $pref->display(['main_class' => 'tab_cadre_fixe']);
    $iframeUrl = 'http://localhost:8080/dashboard-clean';
    echo '<iframe src="' . $iframeUrl . '" width="100%" height="1000vh" frameborder="0"></iframe>';
