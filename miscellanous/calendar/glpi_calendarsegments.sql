...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_calendarsegments">`glpi_3`.`glpi_calendarsegments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_calendars">`glpi_3`.`glpi_calendars`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_calendars_holidays">`glpi_3`.`glpi_calendars_holidays`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_users">`glpi_3`.`glpi_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_tickets_users">`glpi_3`.`glpi_tickets_users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_tickets">`glpi_3`.`glpi_tickets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_changes_tickets">`glpi_3`.`glpi_changes_tickets`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_suppliers">`glpi_3`.`glpi_suppliers`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_profilerights">`glpi_3`.`glpi_profilerights`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=glpi_3&table=glpi_usbvendors">`glpi_3`.`glpi_usbvendors`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
