...
<body class=\"";
   ...
   <div class=\"page\">
      ...
      <div class=\"page-wrapper mb-0\">
         ";
        // line 142
        if (CoreExtension::inFilter("/helpdesk.public.php", $this->extensions['Glpi\Application\View\Extension\RoutingExtension']->indexPath())) {
            // line 143
            yield "            <div class=\"page-body container-fluid\" style=\"background:url(pics/layout/global_layout_background.png);background-repeat:repeat;background-attachment:fixed;\">
         ";
        } else {
            // line 145
            yield "            <div class=\"page-body container-fluid\">
         ";
        }
        // line 147
